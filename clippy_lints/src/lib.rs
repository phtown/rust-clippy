...
mod almost_complete_char_range;
mod approx_const;
mod as_conversions;
mod asm_syntax;
...
pub fn register_plugins(store: &mut rustc_lint::LintStore, sess: &Session, conf: &Conf) {
    ...
    store.register_early_pass(move || Box::new(almost_complete_char_range::AlmostCompleteLetterRange::new(msrv())));
    store.register_early_pass(move || Box::new(almost_complete_char_range::AlmostCompleteDigitRange::new(msrv())));
